...
void QuitGameOver()
{
		...
		int score = GetScore(); //Това е глобална променлива не излизаме от цялото приложение и няма нужда да се записва във файл 
		if ( MaxScore > score )
		{
			SaveScore(MaxScore);
		}
