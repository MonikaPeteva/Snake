...
*/
		...
		//генериране на вътрешните стени
		int n = rand() % (4000/sleepDuration);//брой на вътрешните стени
		int k;              //брой на тухлите в стената
		int p;				//посока в стената
		int l;              //брой тухли в текущата посока
		bool key;	//текущата тухла не съвпада с друга тухла от стената
		COORD coord_brik;	//координати на текущата тухла

		for (int i = 0; i < n; ++i)//за всяка от вътрешните стени
		{
				k = (rand() % 15) + 1;
